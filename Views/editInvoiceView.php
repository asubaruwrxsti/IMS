...
<body>
    <ul>
        <li><a href="/">Faturat Aktive</a></li>
        <li><a href="/create">Krijo Fature</a></li>
        <li><a href="/archivedView">Arkiva</a></li>
    </ul>
    <h1> Edito Fature </h1>
    <?php foreach ($data->getResult() as $key) { ?>
        <form action="/editInvoice/<?= $key->ID ?>" method="post" style="margin: auto; text-align: center;">
            <table>
                <tr>
                    <th>Emri:</th>
                    <td> <input type='text' name='First_Name' placeholder='<?= $key->First_Name ?>'> </input> </td>
                </tr>
                <tr>
                    <th>Mbiemri:</th>
                    <td> <input type='text' name='Last_Name' placeholder='<?= $key->Last_Name ?>'> </input> </td>
                </tr>
                <tr>
                    <th>Kontakt:</th>
